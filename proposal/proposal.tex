...
monthly frequency (seasonally adjusted). This yields a $50 \times 311$
data matrix (we are missing 2025-10)
...
\medskip
\subsection{Secondary Dataset: FRED Macroeconomic Covariates}
In order to answer the secondary question, I will also pull in national macroeconomic covariates from the Federal Reserve Economic Data \\ 
...
shrinkage: states with more noise will be pulled toward the national mean, while states with strong signals can deviate more.
